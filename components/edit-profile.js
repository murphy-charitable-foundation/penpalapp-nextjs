...
const EditProfileImage = () => {
  ...
  const buttonClasses = () => {
    if(!croppedImage){
        return "w-[80%] mx-auto mt-[100px] p-2 bg-[#1C1B1F1F] text-[#1D1D00] rounded-[100px]"
    } 
    return "w-[80%] mx-auto mt-[100px] p-2 bg-[#4E802A] text-white rounded-[100px]"
  }
          ...
          <section>
            <div {...getRootProps()}>
              ...
              <p className='bg-[#65B427] rounded-[50%] h-[220px] w-[220px] mx-auto cursor-pointer flex flex-center'>
                {newProfileImage ? (
                    <img src={previewURL} className='m-auto my-auto' />
                ) : (
