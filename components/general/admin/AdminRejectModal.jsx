      ...
      <div className="w-full max-w-lg bg-white flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <textarea
            ...
            className="w-full min-h-40 border-b-2 border-gray-200 focus:border-b-4 focus:border-primary focus:outline-none resize-none px-4 py-5 bg-gray-100 text-gray-800"
