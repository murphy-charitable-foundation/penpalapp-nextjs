          ...
          <div key={rec.id} className='flex mt-3'>
            ...
            <div className="flex flex-col">
              ...
              <div className='flex gap-x-2 mt-1'>
                {/*{message.messages[0].status === "draft" && <h4 className="text-md">[DRAFT]</h4>}*/}
                <h4 className="text-gray-600 text-sm nowrap">{message.messages[0].content ?? ''}</h4>
                <span className="text-xs text-gray-400">{message.messages[0].received}</span>
              </div>
            </div>
