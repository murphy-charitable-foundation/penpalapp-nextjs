        ...
        <div className="max-w-lg mx-auto  rounded-lg overflow-hidden">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="text-left mt-20">
                      <Input id="password" name="password" type="password" label="New Password" placeholder="*******" value={password} onChange={(e) => setPassword(e.target.value)} />
                  </div>

                  <div className="text-left mt-10">
                      <Input id="repeat-passwod" name="repeatPassword" type="password" placeholder="*******" label="Verified a new Password" value={repeatPassword} onChange={(e) => setRepeatPassword(e.target.value)}/>
                  </div>
