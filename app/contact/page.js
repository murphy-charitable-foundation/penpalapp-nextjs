      ...
      <div className="bg-[#075EA6] shadow rounded-lg p-6 w-full max-w-md">
        ...
        <div className="space-y-6">
          ...
          <Link
            ...
            onClick={() => logButtonEvent("/contact", "instagram")}
          >
          ...
          <Link
            ...
            onClick={() => logButtonEvent("/contact", "linkedin")}
          >
            <button className="flex justify-center items-center text-white hover:text-[#cfe899] py-4">
          ...
          <Link
            ...
            onClick={() => logButtonEvent("/contact", "email")}
          >
            <button className="flex justify-center items-center text-white hover:text-[#cfe899] py-4">
          ...
          <Link
            ...
            onClick={() => logButtonEvent("/contact", "website")}
          >
            <button className="flex justify-center items-center text-white hover:text-[#cfe899] py-4">
